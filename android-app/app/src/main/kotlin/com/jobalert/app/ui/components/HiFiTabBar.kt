...
enum class HomeTab(val label: String, val icon: ImageVector, val route: String) {
    Home("오늘", Icons.Outlined.Home, "main"),
    Search("검색", Icons.Outlined.Search, "search"),
    Discover("찾아보기", Icons.Outlined.Explore, "discover"),
    Favorites("관심기업", Icons.Outlined.FavoriteBorder, "favorites"),
    Me("내정보", Icons.Outlined.Person, "mypage"),
}
