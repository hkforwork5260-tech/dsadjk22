    ...
    companion object {
        ...
        private val RULES: List<Pair<String, List<String>>> = listOf(
            ...
            "it_dev_data" to listOf("개발자", "엔지니어", "백엔드", "프론트엔드", "데이터분석", "데이터 분석",
                ...
                "웹개발", "정보보안", "정보보호", "보안관제", "보안 모니터", "정보통신", "데브옵스", "데이터 사이언",
                ...
                "threat intelligence", "payment fraud", " fds", "robotics", "computer vision", "머신비전"),
            ...
            "marketing_pr" to listOf("마케팅", "홍보", " pr ", "광고", "브랜드마케", "퍼포먼스마케", "그로스",
                "marketing", "marketer", "growth", "brand manager", "brand management", "communications",
                "external relations", "social media", "advertis"),
            "plan_strategy" to listOf("기획", "전략", "사업개발", "경영기획", "프로덕트 매니저",
                "strategy", "product manager", "product management", "program manager", "program management",
                "project manager", "project management", "business development", "business analyst",
                "business controlling", "operations manager", "chief of staff"),
            "sales_trade" to listOf("영업", "판매", "무역", "세일즈", "영업관리", "수출입", "파트너십",
                "sales", "account executive", "account manager", "partnership"),
            "customer_tm" to listOf("고객상담", "상담원", "콜센터", "텔레마케팅", "고객지원", "고객센터", "민원",
                "고객경험", "customer support", "customer success", "support specialist", " cx ", "contact center"),
            "purchase_logistics" to listOf("구매", "자재", "물류", "scm", "조달", "재고관리", "공급망", "창고관리",
                "소싱", "logistics", "supply chain", "procurement", "sourcing", "instock", "warehouse", "fulfillment"),
            "md_planning" to listOf("상품기획", "머천다이저", " md ", "바이어", "상품개발", "상품 검수", "상품검수",
                "상품 모니터", "buyer", "merchandis"),
            "driving_delivery" to listOf("운전", "운송", "배송", "기사", "배달", "택배", "운수", "배차",
